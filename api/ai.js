...
export default async function handler(req, res) {
  ...
  if (body.action === "affiliateResearchGenerate") {
    ...
    const generated=await executeGeminiFreeRequest({text:prompt,boundedContext,feature:"affiliate-research",explicitOwnerAction:true},{credential:process.env.GEMINI_API_KEY});
