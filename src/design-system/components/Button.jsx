...
export function Button({ children, variant = "primary", size = "md", loading: loadingProp = false, pending = false, success = false, disabled = false, disabledReason, className = "", type = "button", ...props }) {
