...
export default function AICEO({
  ...
  return (
    <main className="content">
      ...
      <div className="ceo-grid">
        ...
        <div className="panel">
          ...
          <div className="mission-list">
            <div>事実｜現在売上は{brief.revenue.toLocaleString()}円、月間目標まで残り{brief.remaining.toLocaleString()}円です。</div>
            <div>推測｜今日の期待売上は{brief.todayExpectedRevenue.toLocaleString()}円です。</div>
      ...
      <div className="stats">
        <div className="stat-card"><span>今日の期待売上</span><strong>{brief.todayExpectedRevenue.toLocaleString()}円</strong><p>上位3件の合計</p></div>
