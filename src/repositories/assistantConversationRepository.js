...
const MESSAGE_COLUMNS="id,thread_id,sequence,role,content_text,truth_class,evidence_status,provider,model,provenance,audit_metadata,paid_cost_jpy,external_execution,created_at";
