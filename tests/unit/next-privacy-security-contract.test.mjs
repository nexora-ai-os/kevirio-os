...
test("integration catalog is free-first, explicit, and keeps every external write locked", () => {
  ...
  for (const state of ["COST_POLICY_BLOCKED","CONFIGURED_NOT_ACTIVATED","MANUAL_OPERATION","API_ACCESS_PENDING","FREE_TIER_UNVERIFIED"]) assert.match(catalog,new RegExp(state));
